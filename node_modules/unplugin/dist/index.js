...
__export(src_exports, {
  ...
  creteEsbuildPlugin: () => creteEsbuildPlugin,
  creteRollupPlugin: () => creteRollupPlugin,
  creteRspackPlugin: () => creteRspackPlugin,
  creteVitePlugin: () => creteVitePlugin,
  creteWebpackPlugin: () => creteWebpackPlugin
});
...
function creteEsbuildPlugin(factory) {
  return getEsbuildPlugin(factory);
}
function creteRollupPlugin(factory) {
  return getRollupPlugin(factory);
}
function creteVitePlugin(factory) {
  return getVitePlugin(factory);
}
function creteWebpackPlugin(factory) {
  return getWebpackPlugin(factory);
}
function creteRspackPlugin(factory) {
  return getRspackPlugin(factory);
}
